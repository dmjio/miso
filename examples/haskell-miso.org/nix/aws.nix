...
let
  accessKeyId = "dev";
  region = "us-east-2";
  runner = { pkgs, config, lib, resources, ... }: {
   services.github-runner = {
     enable = true;
     url = "https://github.com/dmjio/miso";
     tokenFile = "/var/lib/runner/token";
     name = "nixos";
   };
   ...
   deployment = {
      ...
      ec2 = {
        ...
        elasticIPv4 = resources.elasticIPs.runner-ip;
...
in
{
  ...
  resources.elasticIPs.runner-ip = {
    inherit region accessKeyId;
    vpc = true;
  };
