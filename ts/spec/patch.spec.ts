...
//         };
//         // dmj: check diff produces patch object
//         expect(getPatches()).toEqual([expected, expectedSetTextContent, appendOperation]);
//         let components : Components<DOMRef> = {};
//         let component : Component<DOMRef> = {
//             model: null,
//             nodes: { 0: document.body },
...
//         };
//         // dmj: check diff produces patch object
//         expect(getPatches()).toEqual([expected, expectedChild, appendOperation1, appendOperation2  ]);
//         let components : Components<DOMRef> = {};
//         let component : Component<DOMRef> = {
//             model: null,
//             nodes: { 0: document.body },
...
//         };
//         // dmj: check diff produces patch object
//         expect(getPatches()).toEqual([expected, expectedChild, newNode, replaceOp, appendOperation1, appendOperation2 ]);
//         let components : Components<DOMRef> = {};
//         let component : Component<DOMRef> = {
//             model: null,
//             nodes: { 0: document.body },
...
//         };
//         // dmj: check diff produces patch object
//         expect(getPatches()).toEqual([expected, appendOperation1, appendOperation2, expectedChild, removeOp ]);
//         let components : Components<DOMRef> = {};
//         let component : Component<DOMRef> = {
//             model: null,
//             nodes: { 0: document.body },
...
//         };
//         // dmj: check diff produces patch object
//       expect(getPatches()).toEqual([expected, appendOperation1, appendOperation2, expectedChild1, expectedChild2, insertBeforeOp, removeChildOp ]);
//         let components : Components<DOMRef> = {};
//         let component : Component<DOMRef> = {
//             model: null,
//             nodes: { 0: document.body },
