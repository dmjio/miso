...
--                        |    |     |   |
-- counter :: 'Component' ROOT props Int Action
-- counter = 'vcomp' m u v
--   where
--     m :: Int
--     m = 0
--
--     u :: Action -> 'Effect' ROOT props Int Action
--     u = \\case
--       Add -> 'this' += 1
--       Subtract -> 'this' -= 1
--
--     v :: props -> Int -> 'View' Int Action
--     v _ x = 'vfrag'
...
--   what props to pass at mount time; the child cannot mutate them.
--
...
--
-- @
-- type 'Effect' parent model action = 'RWS' ('ComponentInfo' parent props) ['Schedule' action] model ()
-- @
--
